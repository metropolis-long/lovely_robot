...
MIDDLEWARE = [
    ...
    # 'daily.mymiddleware.SimpleMiddleware'
]
...
CV_FACE_MODEL_PATH=r"D:\myself-work-space\lovely_robot\.venv\Lib\site-packages\cv2\data\haarcascade_frontalface_alt2.xml"